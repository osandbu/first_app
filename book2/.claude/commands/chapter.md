...
Examples:
  ...
  /chapter p2_c1 draft        — run only the draft phase
  /chapter p3_c1              — run all phases, skipping any already done

Steps:
1. Look up the chapter ID in the book structure (CLAUDE.md)
2. Check which phase files already exist in `book2/content/`
