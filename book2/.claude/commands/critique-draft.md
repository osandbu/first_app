...
Steps:
1. Check that `book2/content/{chapter_id}_draft.md` exists
2. Read the thesis (`book2/content/00_thesis.md`) and the draft
3. Run the critique phase and save `book2/content/{chapter_id}_critique.md`
4. Immediately run the final edit phase, applying the critique's priority fixes
5. Save `book2/content/{chapter_id}_final.md`
