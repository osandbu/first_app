...
Before your next cross-team meeting where you're tempted to argue that a team's behavior is wrong or irrational, write down one sentence: "This team is measured on _____, which means this behavior is locally rational because _____." If you can fill in both blanks, you've found the problem. It's usually not the team.
