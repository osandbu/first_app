...
Michael Jensen and William Meckling described this formally in 1976, writing about what happens when the people who own a firm are not the same people who run it. Managers and shareholders have overlapping but not identical interests. The costs of that gap — monitoring costs, bonding costs, residual loss — exist, they argued, even when everyone involved has good intentions. They are structural, not moral. You don't need corrupt managers for agency costs to emerge. You just need the delegation relationship to exist.

Their paper was about public corporations, but the logic generalizes to any relationship where one person acts on behalf of another. That covers most of organizational life.
...
**Monitoring costs are real, and they often backfire.** The obvious response to the first two problems is to watch more closely. Track the contractor's hours. Review the vendor's methodology. Ask for daily standups. Check the commits. In practice, monitoring has two problems.
...
Second, monitoring changes behavior in ways that defeat its purpose. Teams that know their code is being reviewed will write more careful code during review periods. The behavior is real — but it's a response to the observation, not a durable shift. When the observation stops, the behavior often reverts. You end up with a system where the monitored proxies improve while the underlying reality you care about stays the same or degrades. This is Goodhart's Law operating at the relationship level: the measure becomes the target, and the target is easier to hit than the thing the measure was meant to capture.

The engineers being measured on ticket velocity close more tickets. The ones being measured on code coverage write more tests against already-simple code. The contractor being monitored on hours logged logs carefully. None of this tells you whether the actual work is going well.
...
Understanding this as a structural dynamic rather than a character flaw gives you something to do about it. If you're on the team, make your contributions visible through the channels available to you: write up the technical decisions, participate in the retrospective, build relationships with senior stakeholders directly. Document decisions in forums that create a record. Not as a defensive maneuver — as a normal part of how information flows. Structures that don't naturally surface individual contribution require the individuals to do some of that surfacing themselves.
...
The manager asking for a simpler solution is not wrong to ask. But making the incentive structure clear — and adjusting what gets rewarded — is more reliable than asking people to prioritize organizational efficiency over their own headcount.
...
The open source software community is a real and instructive example of reputation doing most of the work. Contributors to widely-used projects are not primarily motivated by direct financial compensation; they're motivated by peer recognition, career signals, and genuine satisfaction in the work. The community is transparent enough that contribution quality is visible, and relationships are long enough that reputation compounds. It works — not perfectly, but well enough to produce some of the most important software infrastructure in existence.
...
Culture is the cheapest mechanism when it works. The best engineering teams operate this way: people do good work because they care about good work, not because they're being watched. High-functioning team culture produces behavior that surveillance never would.
...
Before you finish this chapter with the impression that everyone you delegate to is a self-interested actor quietly working against you, the framework needs a direct correction.

"Most people want to do good work. This view of organizations is cynical."

This objection is the right one to take seriously, because it's partly right. Most engineers do want to do good work. Most managers aren't consciously stealing credit. Most contractors aren't deliberately over-billing. The principal-agent framework can be misapplied as a lens for treating everyone around you as a potential adversary, which is both factually wrong and personally destructive.
...
The second objection: "You can't design your way out of this — trust matters more than contracts."
...
The longer-term shift is this: when you find yourself in the agent role — which you are, most of the time — one of the most valuable things you can do is surface the information asymmetry explicitly. Tell the principal what you know that they don't. The engineering team that tells a product manager "the three-week estimate includes two days of uncertainty we haven't resolved yet, and here's what we're doing to resolve it" is converting a structural problem into a solvable one. The consultant who says "the standard approach would work for your use case, and the custom build would work better, and here's what the custom build costs us to deliver" is reducing the information gap rather than hiding inside it. This is not just ethically correct — it is strategically effective. Principals who trust their agents give them more autonomy and better relationships. The information asymmetry that produces misalignment also, when reduced intentionally, produces the kind of trust that makes delegation actually work.
